...
<div class="blog<?php echo $this->pageclass_sfx;?>" itemscope itemtype="http://schema.org/Blog">
	...
	<?php endif; ?>
        <?php
           if($this->pagination->pagesCurrent != 1 && $this->params->get('show_pagination') == '2' && JFactory::getApplication()->input->get('tmpl')){
           		$lead_items = array_reverse($this->lead_items);
                foreach($lead_items as $lkey => $lead_item){
                    array_unshift($this->intro_items, $lead_item);
                }
           }
