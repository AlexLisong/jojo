	...
	<dl class="article-info  muted">
		...
		<?php if ($displayData['position'] == 'above' && ($blockPosition == 0 || $blockPosition == 2)
			...
			<?php if ($displayData['params']->get('show_publish_date')) : ?>
				<?php echo JLayoutHelper::render('joomla.content.info_block.xblog_publish_date', $displayData); ?>
			<?php endif; ?>

			<?php if ($displayData['params']->get('show_author') && !empty($displayData['item']->author )) : ?>
				<?php echo JLayoutHelper::render('joomla.content.info_block.xblog_author', $displayData); ?>
			<?php endif; ?>

			<?php if ($displayData['params']->get('show_category')) : ?>
				<?php echo JLayoutHelper::render('joomla.content.info_block.xblog_category', $displayData); ?>
			<?php endif; ?>
